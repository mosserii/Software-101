...
public class FileIndexTester extends AbstractTester {
	...
	public static final String INPUT_FOLDER = "/Users/zoharmosseri/IdeaProjects/hw8-mosserii/resources/hw8/input";
			//"./resources/hw8/input";
	...
	public static void testFileIndex(){
		...
		List<String> topByMin = fIndex.getWordsWithMinRankSmallerThanK(2);//TODO CHECK WHY 2 NOT 3
